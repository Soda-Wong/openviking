...
const QuickStart = () => {
  ...
  const codeExamples = [
    { code: "ov.add_data()", comment: "# Add resources" },
    { code: "client.find()", comment: "# Search context" },
    { code: "session.commit()", comment: "# Save insights" },
  ];
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Get started with OpenViking in seconds
          </p>
        </motion.div>
