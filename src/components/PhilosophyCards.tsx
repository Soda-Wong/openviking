...
const Card1 = () => {
  ...
  const particles = [
    { icon: "📄", label: "PDF", x: 20, y: 20 },
    { icon: "🎬", label: "Video", x: 60, y: 10 },
    { icon: "📊", label: "JSON", x: 80, y: 30 },
    { icon: "💬", label: "Chat", x: 30, y: 50 },
    { icon: "⚙️", label: "Config", x: 70, y: 45 },
  ];
    ...
    >
      ...
      <div className="relative h-48 bg-muted/20 rounded-lg overflow-hidden">
        ...
        <div className="absolute inset-x-0 top-0 h-24">
          {particles.map((p, i) => (
            <motion.div
              ...
              transition={{ duration: phase === 0 ? 1 : 0.5, repeat: phase === 0 ? Infinity : 0 }}
        ...
        <div className="absolute inset-x-4 bottom-4 space-y-1">
          {["Resources", "Sessions", "Skills"].map((folder, i) => (
            <motion.div
              key={folder}
              initial={{ opacity: 0.3 }}
              animate={{
                ...
                boxShadow:
                  phase >= 2 ? "0 0 10px hsl(186 100% 50% / 0.5)" : "none",
              }}
...
const Card2 = () => {
  ...
  const layers = [
    { label: "L2 Abstract", tokens: "<100 tok", width: "40%", color: "from-primary to-primary/50" },
    { label: "L1 Overview", tokens: "<2k tok", width: "70%", color: "from-secondary to-secondary/50" },
    { label: "L0 Detail", tokens: "Deep Work", width: "100%", color: "from-warning to-warning/50" },
  ];
    ...
    >
      ...
      <div className="relative h-48 flex items-center justify-center">
        <div className="flex items-center gap-4 w-full">
          {/* Query */}
          <motion.div
            animate={{ opacity: step >= 0 ? 1 : 0.3, scale: step === 0 ? 1.1 : 1 }}
          ...
          {/* Intent Analysis */}
          <motion.div
            animate={{ opacity: step >= 1 ? 1 : 0.3, scale: step === 1 ? 1.1 : 1 }}
      ...
      <div className="relative h-48 flex items-center justify-center">
        ...
        <div className="relative flex items-center gap-8">
          ...
          <div className="relative w-24 h-16">
            ...
            />
            <RefreshCw className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-6 h-6 text-muted-foreground animate-spin" style={{ animationDuration: "3s" }} />
          </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Four core principles that power OpenViking's intelligent context management
          </p>
        </motion.div>
