        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="relative flex items-center gap-3">
            ...
            borderColor: isInHierarchical ? "hsl(186 100% 50% / 0.5)" : "hsl(215 20% 35% / 0.6)"
              ...
              <svg className="absolute -bottom-6 left-0 right-0 h-10 pointer-events-none overflow-visible" viewBox="0 0 240 36" preserveAspectRatio="xMidYMid meet">
                {/* Background glow effect */}
                <path 
                  d="M 200 4 L 200 16 Q 200 24, 192 24 L 53 24 Q 45 24, 45 16 L 45 4" 
                  fill="none" 
                ...
                {isLooping && <motion.circle 
                  ...
                  fill="hsl(186 100% 50%)" 
                  style={{
                    offsetPath: "path('M 200 4 L 200 16 Q 200 24, 192 24 L 53 24 Q 45 24, 45 16 L 45 4')",
