    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            The <span className="text-gradient">Context File System</span>
            <br />
            for AI Agents
          </motion.h1>
          ...
          >
            Evolve beyond flat vector storage. A file system paradigm that handles storage, retrieval, and
            evolution—freeing you to focus on innovation, not infrastructure.
          </motion.p>
